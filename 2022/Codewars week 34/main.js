...
function hasUniqueChars(str){
    return str.split('').every((char, idx, arr) => arr.indexOf(char)===arr.lastIndexOf(char))
}


function hasUniqueCharsBis(str){
    return new Set(str).size === str.length
}

function hasUniqueCharsThree(str){
    return str.split('').every(function(char, i, arr){
