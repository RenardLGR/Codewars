...
//=========================================
// https://www.codewars.com/kata/5a331ea7ee1aae8f24000175/javascript
// Disclaimer
...
// console.log(triangleHardBis("BRB")) // "G"
// console.log(triangleHardBis("RBRGBRB")) // "G"
// console.log(triangleHardBis("RRGBRGBB")) // "G"
// console.log(triangleHardBis("RBRGBRBGGRRRBGBBBGG")) // "G"
// console.log(triangleBis("")) // "R"
// console.log(triangleHardBis("")) // "R"
//=========================================
// Task
...
function pairs(arr){
    ...
    for(let i=0 ; i<arr.length ; i+=2){
        if(Math.abs(arr[i]-arr[i+1]) === 1) res++
    }
    return res
}
...
function timeDifference(arr){
    ...
    // Convert to minutes, sort it, keep the biggest difference

    let minSorted = arr.map(t => toMin(t)).sort((a,b) => a-b)
    minSorted = minSorted.concat(minSorted[0]+24*60) // make it cyclic
    let res = 0
    for(let i=1 ; i<minSorted.length ; i++){
        if(Math.abs(minSorted[i] - minSorted[i-1]) > res) res = Math.abs(minSorted[i] - minSorted[i-1])
    }

    return toString(res - 1) // alarms ring for an entire minute
    ...
    function toString(min){
        let h = ("0" + Math.floor(min/60)).slice(-2)
        let m = ("0" + min%60).slice(-2)
        return h + ":" + m
    }
}

// console.log(timeDifference(["23:00","04:22","18:05","06:24"])) // "11:40"
